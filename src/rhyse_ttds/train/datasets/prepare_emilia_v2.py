# put in src/rhyse_ttds/train/datasets/prepare_emilia_v2.py
...
from rhyse_ttds.model.utils import repetition_found
...
if __name__ == "__main__":
    ...
    save_dir = str(files("rhyse_ttds").joinpath("../../")) + f"/data/{dataset_name}"
