...
from rhyse_ttds.infer.utils_infer import transcribe
from rhyse_ttds.model.utils import convert_char_to_pinyin
...
path_data = str(files("rhyse_ttds").joinpath("../../data"))
path_project_ckpts = str(files("rhyse_ttds").joinpath("../../ckpts"))
file_train = str(files("rhyse_ttds").joinpath("train/finetune_cli.py"))
