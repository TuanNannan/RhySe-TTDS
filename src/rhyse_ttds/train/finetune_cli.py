...
from rhyse_ttds.model import CFM, DiT, Trainer, UNetT
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional checkpoint output directory. If not set, use ckpts/{dataset_name}.",
    )
...
def main():
    ...
    # checkpoint_path = str(files("rhyse_ttds").joinpath(f"../../ckpts/{args.dataset_name}"))
