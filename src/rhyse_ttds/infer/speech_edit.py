...
from rhyse_ttds.infer.utils_infer import load_checkpoint, load_vocoder, save_spectrogram
from rhyse_ttds.model import CFM
from rhyse_ttds.model.utils import convert_char_to_pinyin, get_tokenizer
...
model_cfg = OmegaConf.load(str(files("rhyse_ttds").joinpath(f"configs/{exp_name}.yaml")))
model_cls = get_class(f"rhyse_ttds.model.{model_cfg.model.backbone}")
...
# ckpt_path = str(files("rhyse_ttds").joinpath("../../")) + f"/ckpts/{exp_name}/model_{ckpt_step}.safetensors"
...
# ctc-forced-aligner --audio_path "src/rhyse_ttds/infer/examples/basic/basic_ref_en.wav" --text_path "tests/test_edit.txt" --language "zho" --romanize --split_size "char"
# [result will be saved at same path of audio file]
# [--language "zho" for Chinese, "eng" for English]
# [if local ckpt, set --alignment_model "../checkpoints/mms-300m-1130-forced-aligner"]

audio_to_edit = str(files("rhyse_ttds").joinpath("infer/examples/basic/basic_ref_en.wav"))
...
# audio_to_edit = "src/rhyse_ttds/infer/examples/basic/basic_ref_zh.wav"
# origin_text = "对，这就是我，万人敬仰的太乙真人。"
# target_text = "对，那就是你，万人敬仰的李白金星。"
