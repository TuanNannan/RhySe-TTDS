# A unified script for inference process 接收和传递采样系数
...
def load_model(
    ...
    if vocab_file == "":
        vocab_file = str(files("rhyse_ttds").joinpath("infer/examples/vocab.txt"))
    tokenizer = "custom"
...
def infer_batch_process(
    ...
    def infer_single_process_streaming(gen_text):
        # for src/rhyse_ttds/socket_server.py
        generated_wave, generated = _infer_basic(gen_text)
        del generated
