...
# Put this file and batch_f5tts_eval2_rhythm_adaptive_ss.py under:
#   /home/user/ly/F5-TTS-main/
# Run:
#   cd /home/user/ly/F5-TTS-main
#   bash run_batch_f5tts_eval2_rhythm_adaptive_ss.sh
...
# =========================
OUT_DIR="${PROJECT_ROOT}/exp/f5ttds_torgo_rhythm_adaptive_ss_eval"
...
# fixed: original F5-TTS; severity: severity-aware SS; rhythm: severity + reference-rhythm-aware SS
...
python batch_f5tts_eval2_rhythm_adaptive_ss.py \
